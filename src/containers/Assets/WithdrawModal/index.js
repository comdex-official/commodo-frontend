...
const WithdrawModal = (lang) => {
  ...
  return (
    <>
      <Button type="primary" size="small" onClick={showModal}>Withdraw</Button>
      <Modal
        centered={true}
...
export default connect(stateToProps, actionsToProps)(WithdrawModal);
